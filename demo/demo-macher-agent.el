...
(defun demo-macher-agent-run ()
  ...
  (demo-macher-agent--type "@macher-agent-plan first spawn two sub-agents and then use the delegate tool to give the task 'What is the capital of France?' to the first, and 'What is the capital of Spain?' to the second concurrently. Show both responses.")
